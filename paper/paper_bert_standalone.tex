...
We benchmark our model against several baselines: (1) Logistic Regression with TF-IDF features, (2) Random Forest with TF-IDF features, (3) Standard Bi-LSTM, and (4) Standalone RoBERTa Classifier. The baseline configurations represent standard implementations for imbalanced text classification.
