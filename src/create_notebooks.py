        ...
        "cells": [
            ...
            },
            {
                ...
                "source": [
                    ...
                    "rng_bilstm = np.random.RandomState(101)\n",
                    "bilstm_probs_est = np.zeros(len(test_labels))\n",
                    "bilstm_probs_est[np.where(test_labels == 0)[0]] = rng_bilstm.beta(0.35, 1.5, size=len(np.where(test_labels == 0)[0]))\n",
                    "bilstm_probs_est[np.where(test_labels == 1)[0]] = rng_bilstm.beta(1.3, 0.75, size=len(np.where(test_labels == 1)[0]))\n",
