        ...
        "cells": [
            ...
            },
            {
                ...
                "source": [
                    ...
                    "test_preds = (test_probs_arr >= 0.5).astype(int)\n",
                    ...
                    "test_prec = precision_score(test_labels_arr, test_preds, zero_division=0)\n",
                    "test_rec = recall_score(test_labels_arr, test_preds)\n",
                    "test_f1 = f1_score(test_labels_arr, test_preds)\n",
                    "test_auc = roc_auc_score(test_labels_arr, test_probs_arr)\n",
                    "\n",
                    ...
                    "\n",
                    "# Macro averages calculations for direct baseline comparison\n",
                    "report_dict = classification_report(test_labels_arr, test_preds, output_dict=True, zero_division=0)\n",
                    "macro_prec = report_dict['macro avg']['precision']\n",
                    "macro_rec = report_dict['macro avg']['recall']\n",
                    "macro_f1 = report_dict['macro avg']['f1-score']\n",
                    "\n",
